...
<body>
    ...
    <div class='msg'> Your order has been submitted. We'll deliver the items soon. <a href='index.php' class='done'>Book Store Home</a> </div>
    <div class='footer'> &copy;
        <?php echo date('Y') ?>. All right reserved. </div>
</body>
